...
'''
    ...
    copy of beginner policy, with weaker strike_policy
...
def make_beginner_policy(np_random):
    ...
    def dull_policy(curr_state, prev_state, prev_action):
        b = curr_state.board
        #player_color = curr_state.color
        #opponent_color = gomoku_util.other_color(player_color)
